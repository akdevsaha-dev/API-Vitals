  ...
  useGSAP(() => {
    const handleScroll = () => {
      ...
      gsap.to(headerRef.current, {
        ...
        borderBottomColor: isScrolled ? "rgba(229, 229, 229, 0.5)" : "rgba(229, 229, 229, 0)",
  ...
  return (
    ...
    >
      <nav className="container mx-auto px-5 2xl:px-0 flex-between w-full">
        <div id="logo" className="font-display text-xl font-extrabold">lumen</div>
        <div>
        ...
        <div className="flex-center font-sans font-light gap-4 text-sm">
          <div className="hover:text-blue-600 transition-colors cursor-pointer">Sign in</div>
          <div className="bg-black group hover:bg-blue-700 hover:border-blue-900 hover:cursor-pointer flex items-center justify-center gap-1 px-5 py-2 text-white transition-all">
            <div>Start free</div>
            <ArrowUpRight
              size={16}
              strokeWidth={2}
