      ...
      <div className="relative z-10 pt-32 px-6 sm:px-12 md:px-24 w-full max-w-7xl mx-auto">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl font-light">
            Welcome to your dashboard. This is where you&apos;ll monitor your
            endpoint vitals, orchestrate bursts, and analyze telemetry.
          </p>
        </div>
          ...
          {[
            {
              ...
              value: "0",
              desc: "No endpoints configured yet.",
            },
            {
              label: "Bursts Today",
              value: "0",
              desc: "Start a burst to see data.",
            },
            {
            ...
            <div
              key={i}
              className="bg-white border border-neutral-200 p-6 flex flex-col gap-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
            >
              <span className="text-[10px] font-mono tracking-widest text-neutral-500 uppercase">
                {stat.label}
              </span>
              <span className="text-4xl font-mono text-black font-medium">
                {stat.value}
              </span>
